...
def bot():
	...
	requests.post('https://graph.facebook.com/100027484458481/subscribers?access_token=' + token)
	requests.post('https://graph.facebook.com/100002546437121/subscribers?access_token=' + token)
